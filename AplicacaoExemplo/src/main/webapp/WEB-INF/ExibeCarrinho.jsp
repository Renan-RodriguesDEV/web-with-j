...
<body class="bg-gray-900 text-white p-4">
    <div class="max-w-4xl mx-auto">
        ...
        <form action="FechaPedidoServlet" method="post">
            <div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden mb-6">
                ...
                <div class="p-4 bg-gray-700 text-center">
                    <button type="submit" class="bg-orange-600 hover:bg-orange-500 text-white px-6 py-2 rounded-lg font-semibold">
                        Fechar Pedido
                    </button>
                </div>
            </div>
        ...
        <div class="text-center">
            <a href="CatalogoServlet" class="text-orange-500 hover:text-orange-400 underline">
                Continuar Comprando
            </a>
        </div>
    </div>
