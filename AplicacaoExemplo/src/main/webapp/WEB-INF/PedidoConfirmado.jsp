	...
	<table border="1">
		...
		<c:forEach var="item" items="${pedido.itens}">
			<tr>
				...
				<td align="right"><fmt:formatNumber value="${item.precoVenda}"
						type="currency" groupingUsed="true" /></td>
				<td align="right"><fmt:formatNumber value="${item.quantidade}"
						type="number" groupingUsed="true" /></td>
				<td align="right"><fmt:formatNumber
						value="${item.precoVenda * item.quantidade}" type="currency"
		...
		<tr>
			...
			<td align="right"><fmt:formatNumber value="${total}"
					type="currency" groupingUsed="true" /></td>
		</tr>
	</table>
	<p>
